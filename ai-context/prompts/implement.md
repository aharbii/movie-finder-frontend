# Implement Prompt — movie-finder-frontend
...
You are implementing GitHub issue #[ISSUE_NUMBER] in `aharbii/movie-finder-frontend`.

Step 1: Fetch the issue.
  gh issue view [ISSUE_NUMBER] --repo aharbii/movie-finder-frontend
...
Step 8: Run quality checks.
  npm run lint && npm test (run `npm ci` first if node_modules is missing)
...
Step 10: Open PR.
  ...
  gh pr create --repo aharbii/movie-finder-frontend --title "..." --body "..."
...
Step 11: Comment on related issues from Agent Briefing.
  gh issue comment [N] --repo [REPO] --body "PR aharbii/movie-finder-frontend#[PR]: [url]. [what this means for that issue]"
